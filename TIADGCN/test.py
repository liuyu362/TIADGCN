...
parser.add_argument('--checkpoint', type=str,
                    default='logs/2025-06-23-11-13-48-128PEMS04/best_model.pth', help='')
...
def main():
    ...
    torch.save(realy,"TIADGCNstamt_04_no_memory_real.pt")
    torch.save(yhat1,"TIADGCNstamt_04_no_memory_pred.pt")
